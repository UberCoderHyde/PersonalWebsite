...
const About = () => {
  ...
  <section id="about" className="p-8 bg-gray-100 dark:bg-gray-900 text-grey-800 dark:text-white text-center">
    <div className="container mx-auto">
      ...
      <p className="text-lg leading-relaxed mb-4">
        Whem im not programming currently im working on other things, for example im in college at UNCC for computer science so im doing class work or 
      </p>
      <p className="text-lg leading-relaxed mb-4">
        I'm currently looking for new opportunities to use and improve my skills and work on exciting projects. Contact me and let's work together!
      </p>
    </div>
  </section>
  );
