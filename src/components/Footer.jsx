  ...
  return (
    <footer className="p-8 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white">
      <div className="container mx-auto text-center">
        <p className="mb-4 text-lg font-medium">Connect with me on social media:</p>
        <div className="mb-4">
          <a
            href="https://www.twitch.com/uber_coder"
            target="_blank"
            rel="noopener noreferrer"
            className="mx-2 text-gray-800 dark:text-white"
          >
        ...
        <p className="text-gray-600 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Colby Meidenbauer. All rights reserved.
        </p>
      </div>
    </footer>
  );
