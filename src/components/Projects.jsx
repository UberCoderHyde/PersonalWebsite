...
const projects = [
  {
    ...
    description: 'Its this website you can check out the source code for the components and the pathfinding algorithms',
  ...
  },
  {
    ...
    description: 'This was my final project for a class in college. In a group of 2 we created a Website with django for people to scedule and join tutoring meetings and to communicate on forums to others in the same class',
  ...
  },
  {
    ...
    description: 'This was my first github repo. It would forcefully check a google doc to see who in the class wrote that they were in class. It could also pick a random person. It didnt use a google api to acheive the end result',
